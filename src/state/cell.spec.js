...
describe('Cell', function() {
    describe('type', function() {
        it('should have crystals', function() {
            ...
            expect(cell.isCrystals()).withContext('cell has crystals').toBeTrue()
            expect(cell.isEggs()).withContext('cell has eggs').toBeFalse()
        ...
        it('should have eggs', function() {
            ...
            expect(cell.isCrystals()).withContext('cell has crystals').toBeFalse()
            expect(cell.isEggs()).withContext('cell has eggs').toBeTrue()
            expect(cell.isEmpty()).withContext('cell isEmpty').toBeFalse()
        })
